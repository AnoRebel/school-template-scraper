...
# this function creates the db and collection and the insertMany function, in primary school list
def mongodbp(data):
...
# this function creates the db and collection and the insertMany function, in secondary school list
def mongodbs(data):
    print('Creating a database:')
	print('.......')
    db = conn.secondary
	...
	print('Creating a collection:')
	print('..........')
    collection = db.secondary_schools

	print('Inserting data info mongo:')
	print('..........')
    collection.insert_many(data)

    print("Finished writing to collection 'secondary'.")
	print(.........))
